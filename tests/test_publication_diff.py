...
class PublicationDiffTests(unittest.TestCase):
    ...
    def test_multiple_promotions_fail_closed(self) -> None:
        errors = validate_transition(
            [
                ("articles/a-valid-slug-123.md", PublicationState(False, None), PublicationState(True, None)),
                ("articles/b-valid-slug-123.md", PublicationState(False, None), PublicationState(True, None)),
            ]
        )
